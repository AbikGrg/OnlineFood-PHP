            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-location-smile f-s-20 color-warning"></i><span class="hide-menu">Locations</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_restaurant.php">Locations</a></li>
								<li><a href="add_category.php">All Location</a></li>
