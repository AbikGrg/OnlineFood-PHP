                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;margin-left: 101px;">3. </span>Visit nepal</h4> </div>
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">$'.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Book Now</a> </div>
                                                </div>
